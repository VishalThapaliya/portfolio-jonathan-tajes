    ...
    <section className="section" id="contact">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                <h2 className="headline-2 lg:max-w-[12ch]">Let's connect</h2>
            ...
            {/*
                Form submit is handled using getform.io portal which is see on the form action behavior below. 
                The email that is used to create getform.io account is "bibi4photos@gmail.com" needs to be changed and configured with the real email address of Jonathan Tajes  
            */}
            <form 
                action="https://getform.io/f/bejjmnga" 
                method="POST"
                ...
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        <input 
                            ...
                            id="email" 
                            autoComplete="email"
                            placeholder="fotografia@jtajes.com"
                            className="text-field"
                            required 
                        />
                    </div>
